	...
	return (
		<div className="aboutMe">
			<p className="education">
				...
				2023. I went from having almost no experience to making apps
				that called APIs! I started out small, making static websites as
				I learned to write HTML and CSS and progressed quickly to Sass,
