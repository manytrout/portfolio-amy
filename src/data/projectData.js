		...
		details: (
			<div className="details">
				...
				<p className="projectOverview">
					...
					vanilla JavaScript. The player is given a mission to protect
					picnic-goers from wasps; after 30 seconds to shoo wasps
					away, getting a point for every wasp that has been
					successfully shoo'd. At the end of 30 seconds the player can
				...
				<p className="planning">
					...
					trying other versions online to see what it was like. When I
					sat down to start actually working on it I went through
					several cycles of breaking it down into progressively
					smaller chunks until I actually got something I could make
					progress on.Then I'd test
				</p>
				<h4>Working</h4>
				<p className="working">
					From the minute I started my <code>game.js</code> file I had
					my debugger open any time I was working on it. I had lots of
					breakpoints -- possibly too many -- throughout my code to
					help me figure out the dataflow. As I finished chunks of my
					work I would get excited that I was closer to being done.
	...
	},
	{
		...
		details: (
			<div className="details">
				<h3 className="projectOverview">Overview</h3>
				<p>
					Movie Love is a basic web app that Kassandra Haftner and I
					wrote in React. It lets users view the 25 movies at the top
					of the <strong>Top Rated</strong>,{" "}
					<strong>Now Playing</strong>, and <strong>Upcoming</strong>{" "}
					categories. Each movie has a card that has some basic data,
					a heart toggle button that connects to the user's Favourites
					list that's stored locally, and a View Details button to
					click into the given movie's page.
				</p>
				<h4>Planning</h4>
				<p className="planning">
				...
				<h4>Working</h4>
				<p className="working">
					Initially my thoughts about which components we'd need and
					how they should be set up turned out to be overly
					complicated but it didn't take us long to re-work the
					structure. I did a most of plumbing, and Kassandra did
					almost all of the styling. We communicated well through the
					whole process, and we each took turns talking the other
					through various issues we encountered.
				</p>
				<h4>Challenges</h4>
				<p className="challenges">
					A new challenge for me was figuring out how to connect to
					the TMDb API, and then how to actually get the data I wanted
					to actually show up -- accessing specific data from an
					object, what! I had to wrap my head around how{" "}
					<strong>props</strong> work too. Next up was learning how,
					when, and where to <strong>useState</strong>,{" "}
	...
	},
	{
		...
		details: (
			<div className="details">
				...
				<p className="working">
					As usual, I relied a lot the React dev tools and soooo much
